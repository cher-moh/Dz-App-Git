...
public class coder {
	public static byte[] createChecksum(String filename) throws Exception {
	   ...
	   public static double taille_file(String fichier,String mesure) {
		   ...
		   switch (mesure) {
		   case "bit": resultats= bytes ; break;
		   case "oct": resultats= bits ; break;
		   case "ko": resultats= kilobytes ;   break;
		   case "mo": resultats= megabytes ; break;
		   case "go": resultats= gigabytes ; break;
		   case "to": resultats= terabytes ; break;	   
		   }
